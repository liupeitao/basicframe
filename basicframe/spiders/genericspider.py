...
from basicframe.playground.spot import judge_list
class GenericSpider(CrawlSpider):
    name = "https://www.cbsnews.com"
    ...
    rules = (
        ...
        Rule(LinkExtractor(),
             callback='parse_all', follow=True, process_links='custom_process_links'),
    )
